      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 border border-orange-500/30 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(255,165,0,0.3)] backdrop-blur-xl">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-orange-500/30 blur-xl animate-ping"></div>
        ...
        {/* Success Message */}
        {isSubscribed && (
          <div className="p-4 mb-6 text-center border bg-green-500/20 border-green-500/50 rounded-xl">
            <p className="flex items-center justify-center gap-2 font-bold text-green-400">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
            ...
            <div className="relative group">
              <FaUser className="absolute z-10 text-lg text-orange-400 -translate-y-1/2 left-4 top-1/2" />
              <input
                type="text"
            ...
            {/* Email Input */}
            <div className="relative group">
              <FaEnvelope className="absolute z-10 text-lg text-orange-400 -translate-y-1/2 left-4 top-1/2" />
              <input
                type="email"
          ...
          >
            <span className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-600 group-hover:opacity-100"></span>
            <span className="relative z-10 flex items-center gap-3">
              <FaBolt className="transition-transform duration-300 group-hover:rotate-12" />
              JOIN THE ARENA NOW
              <FaBolt className="transition-transform duration-300 group-hover:-rotate-12" />
            </span>
          </button>
